...
import hn.alturaforge.mercadox.core.mapper.OrderMapper;
import hn.alturaforge.mercadox.core.util.EmailDispatchUtils;
import hn.alturaforge.mercadox.core.util.OrderUtils;
...
import hn.alturaforge.mercadox.library.entity.ports.incoming.OrderUseCase;
...
import hn.alturaforge.mercadox.library.jpa.repository.OrderItemRepository;
...
public class OrderService implements OrderUseCase {
    ...
    public OrderStatus place(PlaceOrderRequest request) {
        ...
        if(isValidRequest(request.getCartDto())) {
            ...
            List<EmailRecipient> recipientDtos = emailDispatchUtils.mapOrgAdminsToEmailRecipient();
            OrderPayload orderDto = orderMapper.toDto(order);
    ...
    public OrderStatus dispatch(DispatchOrderRequest request) {
        ...
        List<EmailRecipient> recipients = emailDispatchUtils.mapOrgAdminsToEmailRecipient();
